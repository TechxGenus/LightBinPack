...
def calculate_utilization(original_lengths, bin_results, max_length):
    ...
    used_space = sum(
        sum(original_lengths[i] for i in bin_items)
        for group in bin_results
        for bin_items in group
    )
...
def calculate_square_sum_balance(original_lengths, bin_results):
    ...
    for group in bin_results:
        ...
        if group_square_sums:
            ...
            group_imbalance = (
                (max_square_sum - min_square_sum) / max_square_sum
                if max_square_sum > 0
                else 0.0
            )
...
def run_balance_benchmark(
    algorithm, sizes, lengths, max_length, bins_per_group=1, strategy=0, num_runs=3
):
...
def main():
    ...
    results = {
        "OGBFD-1-S0": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 1, strategy=0, num_runs=num_runs
        ),
        "OGBFD-2-S0": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 2, strategy=0, num_runs=num_runs
        ),
        "OGBFD-4-S0": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 4, strategy=0, num_runs=num_runs
        ),
        "OGBFD-8-S0": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 8, strategy=0, num_runs=num_runs
        ),
        "OGBFDP-1-S0": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 1, strategy=0, num_runs=num_runs
        ),
        "OGBFDP-2-S0": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 2, strategy=0, num_runs=num_runs
        ),
        "OGBFDP-4-S0": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 4, strategy=0, num_runs=num_runs
        ),
        "OGBFDP-8-S0": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 8, strategy=0, num_runs=num_runs
        ),
        "OHGBFD-1-S0": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 1, strategy=0, num_runs=num_runs
        ),
        "OHGBFD-2-S0": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 2, strategy=0, num_runs=num_runs
        ),
        "OHGBFD-4-S0": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 4, strategy=0, num_runs=num_runs
        ),
        "OHGBFD-8-S0": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 8, strategy=0, num_runs=num_runs
        ),
        "OGBFD-1-S1": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 1, strategy=1, num_runs=num_runs
        ),
        "OGBFD-2-S1": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 2, strategy=1, num_runs=num_runs
        ),
        "OGBFD-4-S1": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 4, strategy=1, num_runs=num_runs
        ),
        "OGBFD-8-S1": run_balance_benchmark(
            ogbfd, sizes, lengths, batch_max_length, 8, strategy=1, num_runs=num_runs
        ),
        "OGBFDP-1-S1": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 1, strategy=1, num_runs=num_runs
        ),
        "OGBFDP-2-S1": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 2, strategy=1, num_runs=num_runs
        ),
        "OGBFDP-4-S1": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 4, strategy=1, num_runs=num_runs
        ),
        "OGBFDP-8-S1": run_balance_benchmark(
            ogbfdp, sizes, lengths, batch_max_length, 8, strategy=1, num_runs=num_runs
        ),
        "OHGBFD-1-S1": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 1, strategy=1, num_runs=num_runs
        ),
        "OHGBFD-2-S1": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 2, strategy=1, num_runs=num_runs
        ),
        "OHGBFD-4-S1": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 4, strategy=1, num_runs=num_runs
        ),
        "OHGBFD-8-S1": run_balance_benchmark(
            ohgbfd, sizes, lengths, batch_max_length, 8, strategy=1, num_runs=num_runs
        ),
    }
    ...
    print("-" * 65)
    print(
        f"{'Size':>8} {'Algorithm':>12} {'Time(s)':>8} {'Util%':>9} {'Imbalance%':>13} {'Groups':>7}"
    )
    print("-" * 65)
    ...
    for size_idx, size in enumerate(sizes):
        for algo in results:
            ...
            print(
                f"{size:>8} {algo:>12} {time_taken:>8.3f} {utilization:>9.3%} "
