...
std::vector<std::vector<int>> obfd(const std::vector<int> &lengths, int batch_max_length, int item_max_length = -1)
{
...
{
    m.doc() = "Optimized BFD (Best Fit Decreasing) algorithm implementation for "
              "integer lengths";
    m.def("obfd", &obfd, "Optimized BFD algorithm", py::arg("lengths"), py::arg("batch_max_length"),
