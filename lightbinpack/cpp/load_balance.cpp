...
std::vector<std::vector<int>> load_balance_parallel(
...
std::vector<std::vector<int>> load_balance(
    const std::vector<std::vector<int>>& input_data,
    int nodes,
...
std::vector<std::vector<std::vector<int>>> load_balance(
    const std::vector<std::vector<std::vector<int>>>& input_data,
    int nodes,
    bool enable_parallel = true) {
    ...
    result.erase(
        std::remove_if(result.begin(), result.end(), 
            [](const std::vector<std::vector<int>>& v) { return v.empty(); }), 
        result.end()
    );
...
PYBIND11_MODULE(load_balance, m) {
    ...
    m.def("load_balance", py::overload_cast<const std::vector<std::vector<std::vector<int>>>&, int, bool>(&load_balance),
    ...
    m.def("load_balance", py::overload_cast<const std::vector<int>&, int>(&load_balance),
          "Load balancing algorithm for 1D integer list",
          py::arg("input_data"),
          py::arg("nodes") = 2);
}
