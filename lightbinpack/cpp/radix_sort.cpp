...
void counting_sort_by_position(std::vector<std::vector<std::vector<int>>> &data,
                               std::vector<std::vector<std::vector<int>>> &output, int pos, int max_value)
{
    int n = (int)data.size();
...
std::vector<std::vector<std::vector<int>>> radix_sort(const std::vector<std::vector<std::vector<int>>> &input_data,
...
PYBIND11_MODULE(radix_sort, m)
{
    ...
    m.def("radix_sort", &radix_sort, "Radix sort algorithm for sorting integer lists", py::arg("input_data"),
          py::arg("start_index") = 0, py::arg("max_index") = 32, py::arg("max_value") = 16384);
}
